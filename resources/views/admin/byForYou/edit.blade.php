                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form role="form" action="{{ route('byForYouUpdate', ['id'=>$byForYou->id]) }}" method="POST" enctype="multipart/form-data"
                                    autocomplete="off">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ipromName" value="{{$byForYou->ipromName}}" class="form-control"
                                            id="exampleInputPassword1">
                                    </div>
                                    <div class="form-group">
