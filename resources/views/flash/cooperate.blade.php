...
@section('content')
    ...
    <section style="margin-top: 120px" class="section1">
        ...
        <h1>همکاری با ما و کسب در امد</h1><br>
                ...
                @foreach ($cooperate as $item)
                    <li class="flash-cont-by-for-you">
                        <div class="shop-item-con-dis-by-for-you">
                            ...
                            <form action="{{ route('downCooperate', ['id' => $item->id]) }}" method="POST">
                                @csrf
                                <div>
                                    <label for="">برای دانلود باید کد را وارد کنید</label><br><br><br>
                                    <input type="text" class="" name="code" id="">
                                </div>  
