...
@section('content')
    ...
    <section class="section1">
        ...
        <h1 style="text-align: center;display: block;width: 100%;"> موتور جستجوی فایل آپدیت</h1><br>
        ...
        <form action="{{ route('searchUpdate') }}" class="search" method="get">
                ...
                @foreach ($device as $item)
                    <li class="flash-cont">
                        <div class="flash-dis-cont">
                            ...
                            @endif
                            <br>
                            <a class="show-device" href="showDeviceUpdate/{{ $item->id }}">مشاهده جزئیات و خرید</a>
                        </div>
